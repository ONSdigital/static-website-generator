...
describe("createHtmlContentFilter(site)", () => {
  ...
  describe("htmlContentFilter(htmlContent)", () => {
    ...
    it("decorates `<table>` elements with the `ons-table` and `ons-table-scrollable ons-table-scrollable__content ons-u-d-b@xxs@m`  classes", () => {
      const string = htmlContentFilter(`<table>`);

      expect(string).toBe(`<table class="ons-table ons-table-scrollable ons-table-scrollable__content ons-u-d-b@xxs@m">`);
    });
